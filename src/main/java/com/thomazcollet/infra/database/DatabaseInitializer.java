...
public class DatabaseInitializer {
    ...
    public static void initialize() {
        ...
        // 1. Script estrutural base (Modificado para incluir a nova tabela de
        // notificações)
        String setupSql = """
    ...
    /**
     * Adiciona de forma incremental as novas colunas ou tabelas caso o banco de
     * dados do usuário
     * já possua o esquema antigo.
     */
    private static void applyMigrationsIfNecessary(Statement stmt) {
        // Adiciona colunas novas de metas caso o banco já exista sem elas
        try {
        ...
        // MIGRACÃO: Garante a criação da tabela de notificações para bancos de dados já
        // criados
        try {
            stmt.execute("""
                    CREATE TABLE IF NOT EXISTS notifications (
            ...
            logger.error("Erro ao aplicar migração da tabela de notificações", e);
        }
