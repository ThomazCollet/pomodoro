...
public interface AchievementRepository {
    ...
    /**
     * Verifica se o usuário já possui uma conquista específica com base na chave identificadora.
     * Útil para o Fail-Fast antes de rodar queries de validação pesadas.
     */
    boolean isUnlocked(Long profileId, String achievementKey);

    /**
     * Conta o total de conquistas de uma categoria e nível específico obtidas por um usuário.
